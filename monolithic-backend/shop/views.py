...
from shop.models import (
    Domain, Store, StoreManager
)
from shop.permissions import IsStoreAdminOrManager, IsStoreOwner, IsStoreAdmin
from shop.serializers import (
    DomainSerializer, StoreSerializer, StoreManagerSerializer
)
