...
from config.models import (
    AzPackage, AzCountry, AzCity, AzState, MeasureUnit, TimeUnit, AuthorizationType, Authorization
)
from config.permissions import IsSellerOrBoth
from config.serializers import (
    AdminAzPackageSerializer, AdminAzCountrySerializer, AdminAzCitySerializer,
    AdminAzStateSerializer, AdminMeasureUnitSerializer, AdminTimeUnitSerializer,

    SellerAzPackageSerializer, SellerAzCountrySerializer, SellerAzCitySerializer,
    SellerAzStateSerializer, SellerMeasureUnitSerializer, SellerTimeUnitSerializer,

    BuyerAzPackageSerializer, BuyerAzCountrySerializer, BuyerAzCitySerializer,
    BuyerAzStateSerializer, BuyerMeasureUnitSerializer, BuyerTimeUnitSerializer, AdminAuthorizationTypeSerializer,
